...
- [[provider_null]] <<provider_null,null>> (3.2.4)

- [[provider_argocd]] <<provider_argocd,argocd>> (7.12.5)

- [[provider_utils]] <<provider_utils,utils>> (1.31.0)
...
|`string`
|`"https://github.com/GersonRS/modern-gitops-stack-module-traefik.git"`
|no
