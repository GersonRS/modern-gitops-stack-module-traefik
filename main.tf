...
resource "argocd_project" "this" {
  ...
  spec {
    ...
    source_repos = ["https://github.com/GersonRS/modern-gitops-stack-module-traefik.git"]
...
resource "argocd_application" "this" {
  ...
  spec {
    ...
    source {
      repo_url        = "https://github.com/GersonRS/modern-gitops-stack-module-traefik.git"
      path            = "charts/traefik"
